...
@Component({
  selector: 'app-configuration-certificate',
  templateUrl: './configuration-certificate.component.html',
  styleUrls: ['./configuration-certificate.component.css']
})
export class ConfigurationCertificateComponent implements OnInit {

  selectedFormatos: string;
  selectedFirmas: string;
  selectedTipos: string;
  public CantidadFirmas
  public checkoutForm;
  public archivo
  public encod
  ...
  formatos = [
    ...
    {value: 'V', name: 'Vertical'},
  ];
  firmas = [
    {value: 1, name: 'Una Firma (1)'},
    {value: 2, name: 'Dos Firmas(2)'},
    {value: 3, name: 'Tres Firmas(3)'},
    {value: 4, name: 'Cuatro Firmas(4)'},
  ];
  tipos = [
    {value: 'C', name: 'Certificado'},
    {value: 'D', name: 'Diploma'},
  ];
  constructor(
    ...
    this.checkoutForm = this.formBuilder.group({
      ...
      firma: '',
      hiercdcdsarchy: '',
      head: "El Comandante General del Ejército Bolivariano, previo voto favorable del consejo de la Insignia Barra 'Honor al Mérito de la Comandancia General del Ejército Bolivariano', Otorga el Presente Diploma con la Insignia Correspondiente en su Única Clase al ciudadano (a):",
      footer: "Por haber acumulado méritos suficientes que lo hacen acreedor a tal distinción de acuerdo al artículo 15 Aparte 'G' del reglamento respectivo",
    });
   }
  ...
  probarPDF(formData) {
    ...
    this.CantidadFirmas = formData.firma
    if (formData.formato == 'V') {
      const doc = new jsPDF();
      ...
      doc.addImage('assets/certificados/cacfr.png', "PNG", 60,80, 70, 70);
      ...
      doc.text(formData.hiercdcdsarchy == 'C' ? 'CERTIFICADO' : 'DÍPLOMA', pageWidth / 2, pageHeight - 220, { align: "center" });
      ...
      doc.text(formData.head, 14,110, { maxWidth: 180, align: "justify" });
  
    doc.setFontSize(18);
    doc.text("GDO/JQUIA. NOMBRES Y APELLIDOS",
   ...
   switch (this.CantidadFirmas) {
    ...
    default:
      ...
      // doc.save("a4.pdf");
      doc.autoPrint();
      this.archivo = doc.output("dataurlnewwindow", { filename: 'Cerfificado' });
      ...
      doc.setProperties({
        ...
        author: "SISTEMA DE AULAS VIRTUALES",
        keywords: "generated, javascript, web 2.0, ajax",
        creator: "GDO/JQUIA. NOMBRES Y APELLIDOS",
      });
      ...
      doc.setFontSize(30);
      doc.setFont(undefined, "bold");
      doc.text(formData.hiercdcdsarchy == 'C' ? 'CERTIFICADO' : 'DÍPLOMA', pageWidth / 2, pageHeight - 150, { align: "center" });
  
      doc.setFontSize(14);
      doc.text(formData.head,
      // doc.text("El Comandante General del Ejército Bolivariano, previo voto favorable del consejo de la Insignia Barra 'Honor al Mérito de la Comandancia General del Ejército Bolivariano', Otorga el Presente Diploma  con la Insignia Correspondiente en su Única Clase al ciudadado (a): ",
